...
class CommentFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    {
        $comment = new Comment();
        $comment->setUser($manager->merge($this->getReference('user-5')));
        ...
        $comment = new Comment();
        $comment->setUser($manager->merge($this->getReference('user-4')));
        ...
        $comment = new Comment();
        $comment->setUser($manager->merge($this->getReference('user-3')));
