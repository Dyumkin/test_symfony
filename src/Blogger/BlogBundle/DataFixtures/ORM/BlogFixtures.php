...
use Blogger\BlogBundle\Entity\Post as Blog;
...
class BlogFixtures extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $blog1->setAuthor($manager->merge($this->getReference('user-1')));
        ...
        $blog2->setAuthor($manager->merge($this->getReference('user-2')));
        ...
        $blog3->setAuthor($manager->merge($this->getReference('user-3')));
        ...
        $blog4->setAuthor($manager->merge($this->getReference('user-4')));
        ...
        $blog5->setAuthor($manager->merge($this->getReference('user-5')));
